...
if(isset($postdata) && !empty($postdata))
{
    ...
    $subcat_id = mysqli_real_escape_string($con, trim($request->subcat_id));
    $policies = [];
    $sql = "SELECT * FROM product where status_id = 1 and category_id = {$cat_id} and subcategory_id={$subcat_id}";
